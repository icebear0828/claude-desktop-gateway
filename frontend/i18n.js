...
export const messages = {
  en: {
    ...
    "sections.providersAndApps": "Providers and Apps",
    ...
    "desktop.repair": "REPAIR CONFIG",
    "desktop.appliedId": "APPLIED ID",
    "desktop.activeProfile": "ACTIVE PROFILE",
    "desktop.noIssues": "NO CONFIG ISSUES FOUND",
    "desktop.repairDone": "Claude Desktop config repaired. Fully quit and restart Claude Desktop.",
    "desktop.bridgeRepairUnavailable": "Wails bridge unavailable. Launch the desktop app to repair Claude Desktop config.",
    "codex.title": "CODEX APP",
    "codex.repair": "REPAIR CONFIG",
    "codex.activeProvider": "ACTIVE PROVIDER",
    "codex.model": "MODEL",
    "codex.config": "CONFIG",
    "codex.noIssues": "NO CONFIG ISSUES FOUND",
    "codex.repairDone": "Codex App config repaired. Restart Codex App before using the repaired provider.",
    "codex.bridgeRepairUnavailable": "Wails bridge unavailable. Launch the desktop app to repair Codex App config.",
  ...
  "zh-CN": {
    ...
    "sections.providersAndApps": "供应商与应用",
    "gateway.title": "网关",
    ...
    "providers.profile": "协议",
    "providers.baseUrl": "接口地址",
    "providers.apiKey": "密钥变量",
    ...
    "desktop.repairDone": "Claude Desktop 配置已修复。请完全退出并重启 Claude Desktop。",
    "desktop.bridgeRepairUnavailable": "Wails 桥接不可用。请通过桌面应用修复 Claude Desktop 配置。",
    "codex.title": "Codex App",
    "codex.repair": "修复配置",
    "codex.activeProvider": "当前供应商",
    "codex.model": "模型",
    "codex.config": "配置文件",
    "codex.noIssues": "未发现配置问题",
    "codex.repairDone": "Codex App 配置已修复。请重启 Codex App 后使用修复后的供应商。",
    "codex.bridgeRepairUnavailable": "Wails 桥接不可用。请通过桌面应用修复 Codex App 配置。",
    "status.unknown": "未知",
    "status.ok": "正常",
    "status.error": "错误",
    "status.warning": "警告",
